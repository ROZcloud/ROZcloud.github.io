...
# KevosOS - System Operacyjny w C

**KevosOS** to autorski projekt systemu operacyjnego tworzonego od podstaw przez **ROZcloud**. Projekt powstał z chęci zrozumienia niskopoziomowej komunikacji ze sprzętem, zarządzania pamięcią oraz budowania własnego środowiska graficznego w trybie tekstowym (TUI).

## Co wyróżnia KevosOS?

W przeciwieństwie do wielu edukacyjnych projektów typu "kernel", KevosOS stawia na własny framework GUI, który zapewnia:
...
## Wesprzyj projekt
Jeśli podoba Ci się kierunek, w którym zmierza KevosOS, możesz śledzić postępy w repozytorium na GitHubie. KevosOS jest udostępniony na licencji **MIT**, więc każdy może analizować i modyfikować kod.
